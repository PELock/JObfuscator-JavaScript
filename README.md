...
[![npm](https://img.shields.io/npm/v/jobfuscator)](https://www.npmjs.com/package/jobfuscator)
[![License](https://img.shields.io/npm/l/jobfuscator)](https://github.com/PELock/JObfuscator-JavaScript/blob/main/LICENSE)
[![Node.js](https://img.shields.io/node/v/jobfuscator)](https://nodejs.org/)
...
```bash
npm install jobfuscator
```

Or with [yarn](https://yarnpkg.com/):

```bash
yarn add jobfuscator
```

Or with [pnpm](https://pnpm.io/):

```bash
pnpm add jobfuscator
```

Or add this entry directly to your `package.json` in dependencies:

```json
"jobfuscator": "^1.1.0"
```

The installation package is available at https://www.npmjs.com/package/jobfuscator
